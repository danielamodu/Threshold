...
import { AlertTriangle, BookOpenText, FileClock, FilePlus2, Gauge, LogOut, MapPinned, Route as RouteIcon, Settings2, ShieldCheck, UsersRound } from "lucide-react";
...
const navigation: Record<DemoRole, NavItem[]> = {
  admin: [{ label: "Routes", page: "routes", icon: RouteIcon }, { label: "Create route", page: "create", icon: FilePlus2 }, { label: "Organisation", page: "settings", icon: Settings2 }, { label: "Members", page: "members", icon: UsersRound }],
